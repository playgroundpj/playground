...
const boardgameReducer = handleActions(
    {
        [GET_BOARDGAME]: (state, { payload }) => payload,
        [POST_REGISTER]: (state, { payload }) => payload,
        [GET_BOARDGAME_ID]: (state, { payload }) => payload,
        [PUT_BOARDGAME]: (state, { payload }) => payload,
        [DELETE_BOARDGAME]: (state, { payload }) => payload,
        [GET_BOARDGAME_LIST]: (state, { payload }) => payload,
    },
    initialState
);
