...
INSERT INTO tbl_notice (member_code, notice_title, notice_content, create_date, modifyed_date, notice_category) VALUES
                                                                                                                    (1, '새로운 보드게임 입고', '안녕하세요! 보드게임 카페에 새로운 보드게임이 대거 입고되었습니다. 다양한 장르와 난이도의 보드게임을 준비했으니, 여러분의 많은 관심과 방문 부탁드립니다. 새로운 게임 목록은 홈페이지에서 확인하실 수 있으며, 매장에서도 자세한 안내를 받으실 수 있습니다. 즐거운 보드게임 시간이 되시길 바랍니다.', '2024-01-15', '2024-01-15', '공지사항'),
                                                                                                                    (1, '여름 이벤트: 토너먼트', '여름을 맞아 보드게임 토너먼트 이벤트를 개최합니다. 참가자는 다양한 게임을 통해 실력을 겨루게 되며, 우승자에게는 푸짐한 상품이 주어집니다. 이번 토너먼트는 7월 1일부터 시작되며, 참가 신청은 온라인과 오프라인 모두 가능합니다. 자세한 일정과 규칙은 홈페이지를 참고해 주세요. 많은 참여 부탁드립니다.', '2024-06-05', '2024-06-05', '이벤트'),
                                                                                                                    (1, '테이블 예약 방법', '보드게임 카페에서 테이블을 예약하는 방법을 안내드립니다. 전화 또는 온라인 예약 시스템을 통해 쉽게 예약이 가능합니다. 예약은 최소 하루 전에는 완료해 주셔야 하며, 예약 취소는 24시간 이전에만 가능합니다. 예약 관련 문의는 고객센터로 연락해 주시기 바랍니다. 쾌적한 게임 환경을 위해 많은 협조 부탁드립니다.', '2024-02-20', '2024-02-20', '자주묻는질문'),
                                                                                                                    (1, '영업시간 변경 안내', '6월부터 보드게임 카페의 영업시간이 변경됩니다. 평일은 오전 10시부터 오후 10시까지, 주말은 오전 10시부터 자정까지 운영됩니다. 새로운 영업시간에 맞춰 방문 계획을 세워 주세요. 변경된 영업시간에 대해 궁금한 사항이 있으시면 언제든지 문의해 주세요. 항상 고객 여러분의 편의를 위해 최선을 다하겠습니다.', '2024-05-02', '2024-05-02', '공지사항'),
                                                                                                                    (1, '신규 회원 혜택', '신규 회원 가입 시 다양한 혜택을 드립니다. 회원 가입 후 첫 방문 시 음료 한 잔을 무료로 제공해 드리며, 추가로 10% 할인 쿠폰을 증정합니다. 또한, 회원 전용 이벤트와 할인 혜택을 누리실 수 있습니다. 지금 바로 가입하시고 풍성한 혜택을 누려보세요. 더 자세한 내용은 홈페이지를 참고해 주세요.', '2024-04-18', '2024-04-18', '이벤트'),
                                                                                                                    (1, '회원 등급별 혜택 안내', '회원 등급에 따라 다양한 혜택을 제공합니다. 일반 회원, 골드 회원, 플래티넘 회원으로 나누어져 있으며, 등급별로 할인 혜택, 우선 예약, 생일 쿠폰 등 다양한 혜택을 누리실 수 있습니다. 회원 등급은 이용 횟수와 금액에 따라 자동으로 업데이트됩니다. 자세한 혜택 내용은 홈페이지에서 확인해 주세요.', '2024-03-02', '2024-03-02', '자주묻는질문'),
                                                                                                                    (1, '보드게임 대여 서비스', '이제 보드게임을 집에서도 즐길 수 있는 대여 서비스를 시작합니다. 다양한 보드게임을 1일, 3일, 7일 단위로 대여할 수 있으며, 대여료는 게임에 따라 상이합니다. 대여 방법은 매장 방문 또는 온라인 신청을 통해 가능합니다. 대여한 게임은 직접 반납해 주셔야 하며, 반납 시 손상이 없는지 확인 부탁드립니다.', '2024-01-20', '2024-01-20', '공지사항'),
                                                                                                                    (1, '여름 휴가 일정', '여름 휴가로 인해 8월 1일부터 8월 7일까지 보드게임 카페가 휴무입니다. 휴가 기간 동안 카페 이용이 불가하니, 방문 계획에 참고해 주세요. 휴가 이후에는 더 나은 서비스와 함께 찾아뵙겠습니다. 이용에 불편을 드려 죄송하며, 즐거운 여름 보내시길 바랍니다.', '2024-07-01', '2024-07-01', '공지사항'),
                                                                                                                    (1, '주말 특별 할인', '주말에 방문하시면 모든 보드게임 이용료가 20% 할인됩니다. 이번 주말, 친구나 가족과 함께 오셔서 다양한 게임을 즐겨보세요. 할인 혜택은 주말에만 적용되며, 추가 혜택과 중복 적용이 불가합니다. 더 자세한 내용은 매장 내 안내를 참고해 주세요. 많은 이용 부탁드립니다.', '2024-06-15', '2024-06-15', '이벤트'),
                                                                                                                    (1, '주차 안내', '보드게임 카페를 방문하실 때 주차는 건물 뒷편 주차장을 이용해 주세요. 주차 공간이 제한되어 있으니, 가능한 대중교통을 이용해 주시면 감사하겠습니다. 주차 관련 문의는 매장 내 안내 데스크에 문의해 주세요. 고객 여러분의 편리한 이용을 위해 최선을 다하겠습니다.', '2024-04-10', '2024-04-10', '자주묻는질문'),
                                                                                                                    (1, '신규 보드게임 추천', '이번 달 새로 입고된 보드게임 중 추천하는 게임 목록입니다. 전략 게임, 협력 게임, 가족 게임 등 다양한 장르의 보드게임을 소개합니다. 새로운 게임을 친구들과 함께 즐겨보세요. 자세한 내용은 매장 내 추천 코너에서 확인하실 수 있습니다.', '2024-02-11', '2024-02-11', '공지사항'),
                                                                                                                    (1, '겨울 이벤트: 크리스마스 파티', '크리스마스를 맞아 특별 파티를 개최합니다. 다양한 보드게임과 함께하는 크리스마스 파티에 여러분을 초대합니다. 파티에는 특별한 이벤트와 선물도 준비되어 있으니, 많은 참여 부탁드립니다. 사전 예약은 필수이며, 예약 방법은 홈페이지를 참고해 주세요.', '2024-11-15', '2024-11-15', '이벤트'),
                                                                                                                    (1, '음식 반입 안내', '보드게임 카페에서는 외부 음식 반입이 금지되어 있습니다. 카페 내에서 제공하는 음식과 음료를 이용해 주시기 바랍니다. 다양한 메뉴가 준비되어 있으니, 즐겁고 편안한 시간을 보내실 수 있습니다. 음식 관련 문의는 매장 내 안내 데스크에 문의해 주세요.', '2024-03-13', '2024-03-13', '자주묻는질문'),
                                                                                                                    (1, '보드게임 워크샵', '보드게임 초보자를 위한 워크샵을 개최합니다. 워크샵에서는 다양한 게임의 규칙과 전략을 배우실 수 있으며, 실제 게임 플레이도 진행됩니다. 참가비는 무료이며, 사전 예약이 필요합니다. 많은 참여 부탁드립니다. 자세한 내용은 홈페이지를 참고해 주세요.', '2024-04-15', '2024-04-15', '이벤트'),
                                                                                                                    (1, '카페 리모델링 안내', '더 나은 서비스를 제공하기 위해 카페 리모델링을 진행합니다. 리모델링 기간 동안 일부 시설 이용이 제한될 수 있습니다. 불편을 드려 죄송하며, 리모델링 후에는 더욱 쾌적한 환경에서 여러분을 맞이하겠습니다. 자세한 일정은 추후 공지해 드리겠습니다.', '2024-05-01', '2024-05-01', '공지사항'),
                                                                                                                    (1, '주말 특별 이벤트', '주말에만 진행되는 특별 이벤트를 준비했습니다. 다양한 게임과 이벤트가 기다리고 있으니, 친구들과 함께 즐거운 시간을 보내세요. 이벤트 참여는 무료이며, 사전 예약이 필요합니다. 자세한 내용은 홈페이지를 참고해 주세요. 많은 참여 부탁드립니다.', '2024-06-22', '2024-06-22', '이벤트'),
                                                                                                                    (1, '회원 가입 방법', '보드게임 카페 회원 가입은 온라인과 오프라인 모두 가능합니다. 회원 가입 시 다양한 혜택이 주어지며, 회원 전용 이벤트에도 참여할 수 있습니다. 가입 방법은 홈페이지를 참고하시거나, 매장 내 안내 데스크에서 안내받으실 수 있습니다.', '2024-01-10', '2024-01-10', '자주묻는질문'),
                                                                                                                    (1, '보드게임 대회 우승자 발표', '최근 진행된 보드게임 대회의 우승자를 발표합니다. 우승자에게는 푸짐한 상품이 주어지며, 참가해 주신 모든 분들께 감사드립니다. 대회 결과는 홈페이지와 매장 내 게시판에서 확인하실 수 있습니다. 다음 대회에도 많은 참여 부탁드립니다.', '2024-05-20', '2024-05-20', '공지사항'),
                                                                                                                    (1, '봄맞이 이벤트', '봄을 맞아 특별 이벤트를 준비했습니다. 다양한 보드게임과 함께하는 봄맞이 이벤트에 많은 참여 부탁드립니다. 이벤트 기간 동안 특별 할인과 함께 다양한 경품도 준비되어 있습니다. 자세한 내용은 홈페이지를 참고해 주세요.', '2024-04-05', '2024-04-05', '이벤트'),
                                                                                                                    (1, '반려동물 입장 안내', '보드게임 카페는 반려동물 동반이 제한됩니다. 반려동물과 함께 오실 경우, 입장이 불가하오니 양해 부탁드립니다. 보다 쾌적한 환경을 제공하기 위한 조치이니, 많은 이해와 협조 부탁드립니다. 궁금한 사항은 고객센터로 문의해 주세요.', '2024-02-22', '2024-02-22', '자주묻는질문'),
                                                                                                                    (1, '할로윈 파티 안내', '할로윈을 맞아 보드게임 카페에서 특별 파티를 개최합니다. 다양한 게임과 이벤트로 가득한 할로윈 파티에 여러분을 초대합니다. 코스튬을 입고 오시면 특별한 혜택도 제공됩니다. 사전 예약이 필요하며, 예약 방법은 홈페이지를 참고해 주세요.', '2024-10-15', '2024-10-15', '이벤트'),
                                                                                                                    (1, '신규 보드게임 입고 안내', '새로운 보드게임이 입고되었습니다. 다양한 장르의 게임이 추가되었으니, 친구들과 함께 즐기러 오세요. 신작 게임의 자세한 목록은 매장 내 안내판에서 확인하실 수 있습니다. 많은 관심과 방문 부탁드립니다.', '2024-03-11', '2024-03-11', '공지사항'),
                                                                                                                    (1, '이벤트 일정 변경', '예정된 이벤트 일정이 변경되었습니다. 변경된 일정은 홈페이지와 매장 내 게시판에서 확인하실 수 있습니다. 변경된 일정에 따라 계획을 세워 주시기 바라며, 이용에 불편을 드려 죄송합니다. 궁금한 사항은 고객센터로 문의해 주세요.', '2024-05-18', '2024-05-18', '공지사항'),
                                                                                                                    (1, '예약 변경 안내', '예약 변경은 온라인과 전화로 가능합니다. 예약 변경 시 추가 비용이 발생할 수 있으며, 변경은 최소 24시간 전에 해 주셔야 합니다. 예약 관련 문의는 고객센터로 연락해 주시기 바랍니다. 편리한 예약 서비스를 위해 최선을 다하겠습니다.', '2024-04-22', '2024-04-22', '자주묻는질문'),
                                                                                                                    (1, '가을 이벤트', '가을을 맞아 특별 이벤트를 준비했습니다. 다양한 게임과 함께 가을의 즐거움을 만끽해 보세요. 이벤트 기간 동안 특별 할인과 함께 다양한 경품도 준비되어 있습니다. 자세한 내용은 홈페이지를 참고해 주세요. 많은 참여 부탁드립니다.', '2024-09-05', '2024-09-05', '이벤트'),
                                                                                                                    (1, '새로운 멤버십 혜택', '새로운 멤버십 혜택이 추가되었습니다. 멤버십 회원은 다양한 할인 혜택과 우선 예약, 생일 쿠폰 등 특별한 혜택을 누릴 수 있습니다. 지금 바로 멤버십에 가입하시고 풍성한 혜택을 누려보세요. 자세한 내용은 홈페이지를 참고해 주세요.', '2024-03-15', '2024-03-15', '공지사항'),
                                                                                                                    (1, '게임 시간 안내', '보드게임 카페의 모든 게임은 기본 2시간 이용 기준입니다. 추가 시간이 필요한 경우, 추가 요금을 지불하시면 연장 가능합니다. 게임 시간 관련 문의는 매장 내 안내 데스크에 문의해 주세요. 즐거운 게임 시간을 보내시길 바랍니다.', '2024-02-05', '2024-02-05', '자주묻는질문'),
                                                                                                                    (1, '특별 회원 초청 이벤트', '특별 회원을 위한 초청 이벤트를 개최합니다. 다양한 보드게임과 함께 특별한 시간을 보내세요. 이번 이벤트는 10월 10일에 열리며, 참가 신청은 홈페이지를 통해 가능합니다. 많은 참여 부탁드립니다.', '2024-09-25', '2024-09-25', '이벤트'),
                                                                                                                    (1, '자주 묻는 질문: 환불 정책', '환불 정책은 어떻게 되나요? 환불은 24시간 이내에만 가능합니다. 더 자세한 사항은 매장 내 안내 데스크에 문의해 주세요. 고객 여러분의 편리한 이용을 위해 항상 최선을 다하겠습니다.', '2024-02-25', '2024-02-25', '자주묻는질문'),
                                                                                                                    (1, '연말 파티', '연말 파티에 초대합니다! 다양한 게임과 이벤트로 즐거운 시간을 보내세요. 파티는 12월 31일에 열리며, 사전 예약이 필요합니다. 예약 방법은 홈페이지를 참고해 주세요.', '2024-12-01', '2024-12-01', '이벤트'),
                                                                                                                    (1, '여름 휴가 공지', '여름 휴가로 인해 8월 1일부터 8월 7일까지 휴무입니다. 이용에 참고해 주세요.', '2024-07-01', '2024-07-01', '공지사항'),
                                                                                                                    (1, '음식 주문 안내', '음식 주문은 어떻게 하나요? 카페 내에서 직접 주문할 수 있습니다. 다양한 메뉴가 준비되어 있으니 즐거운 시간을 보내세요.', '2024-03-10', '2024-03-10', '자주묻는질문'),
                                                                                                                    (1, '보드게임 대회 안내', '보드게임 대회에 참가하세요! 우승자에게는 멋진 상품이 주어집니다. 대회는 6월 20일부터 시작됩니다. 참가 신청은 온라인과 오프라인 모두 가능합니다.', '2024-05-10', '2024-05-10', '이벤트'),
                                                                                                                    (1, '신규 보드게임 소개', '새로운 보드게임이 추가되었습니다. 지금 바로 확인해보세요! 다양한 장르의 보드게임을 준비했습니다.', '2024-04-15', '2024-04-15', '공지사항'),
                                                                                                                    (1, '분실물 안내', '분실물이 발생한 경우 어떻게 하나요? 분실물은 카운터에 문의해 주세요.', '2024-02-12', '2024-02-12', '자주묻는질문'),
                                                                                                                    (1, '겨울 휴가 일정', '겨울 휴가로 인해 12월 24일부터 1월 2일까지 휴무입니다. 이용에 참고해 주세요.', '2024-12-10', '2024-12-10', '공지사항'),
                                                                                                                    (1, '여름 이벤트: 특별 할인', '여름 동안 특별 할인이 진행됩니다. 많은 이용 부탁드립니다.', '2024-06-01', '2024-06-01', '이벤트'),
                                                                                                                    (1, '어린이 입장 안내', '어린이도 입장 가능한가요? 보호자 동반 시 어린이 입장이 가능합니다.', '2024-03-18', '2024-03-18', '자주묻는질문'),
                                                                                                                    (1, '보드게임 워크샵 안내', '보드게임을 처음 접하는 분들을 위한 워크샵을 진행합니다. 많은 참여 바랍니다.', '2024-05-05', '2024-05-05', '이벤트'),
                                                                                                                    (1, '신규 보드게임 입고 소식', '신규 보드게임이 입고되었습니다. 다양한 게임을 즐기러 오세요!', '2024-04-01', '2024-04-01', '공지사항'),
                                                                                                                    (1, '단체 예약 안내', '단체 예약은 어떻게 하나요? 단체 예약은 전화로 문의해 주세요.', '2024-02-28', '2024-02-28', '자주묻는질문'),
                                                                                                                    (1, '할로윈 이벤트 안내', '할로윈을 맞아 특별 이벤트를 진행합니다. 다양한 게임과 함께 할로윈을 즐겨보세요.', '2024-10-20', '2024-10-20', '이벤트'),
                                                                                                                    (1, '겨울 시즌 보드게임 추천', '겨울 시즌을 맞아 추천하는 보드게임 목록입니다. 친구들과 함께 즐겨보세요.', '2024-12-05', '2024-12-05', '공지사항'),
                                                                                                                    (1, '이벤트 참여 안내', '이벤트 참여 방법은 무엇인가요? 이벤트는 홈페이지를 통해 신청 가능합니다.', '2024-05-12', '2024-05-12', '자주묻는질문'),
                                                                                                                    (1, '보드게임 카페 운영시간 안내', '카페 운영시간이 변경되었습니다. 평일은 오전 10시부터 오후 10시까지, 주말은 오전 10시부터 자정까지 운영합니다.', '2024-05-01', '2024-05-01', '공지사항');
