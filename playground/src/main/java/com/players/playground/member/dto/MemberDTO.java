...
/* 설명. DB 스키마 확인하여 MemberDTO 작성 후, UserDetails를 상속받아 추가적으로 설계한다. */
public class MemberDTO implements UserDetails {
    ...
    public MemberDTO(int memberCode, String memberId, String memberPassword, String memberNickname, String memberBirth, String memberPhonenumber, String memberAddress, String memberEmail, List<MemberRoleDTO> memberRole, Collection<GrantedAuthority> authorities) {
