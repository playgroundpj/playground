...
import com.players.playground.jwt.JwtAccessDeniedHandler;
import com.players.playground.jwt.JwtAuthenticationEntryPoint;
import com.players.playground.jwt.JwtFilter;
...
//		configuration.setAllowedOrigins(Arrays.asList("http://localhost:3333", "http://13.209.160.111" ,"http://jaehong0831.store"));
//		configuration.setAllowedOrigins(Arrays.asList("http://localhost:3333", "http://jaehong0831.store"));
