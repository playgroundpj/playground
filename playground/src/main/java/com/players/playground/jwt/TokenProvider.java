package com.players.playground.jwt;

import com.players.playground.exception.TokenException;
...
public class TokenProvider {
	...
	public TokenDTO generateTokenDTO(Member member) {
		...
		/* 설명. 2-1. 회원의 권한들을 "auth"라는 클레임으로 토큰에 추가 */
		claims.put(AUTHORITIES_KEY, roles);

		/* 설명. 2-2. 회원의 닉네임을 "nickname"라는 클레임으로 토큰에 추가 */
		...
		return new TokenDTO(BEARER_TYPE, member.getMemberNickname(), accessToken, accessTokenExpiresIn.getTime());
	}
